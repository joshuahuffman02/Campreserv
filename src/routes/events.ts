...
eventsRouter.post("/", requireAuth([Role.admin, Role.staff]), async (req, res) => {
...
eventsRouter.put("/:id", requireAuth([Role.admin, Role.staff]), async (req, res) => {
...
eventsRouter.delete("/:id", requireAuth([Role.admin]), async (req, res) => {
